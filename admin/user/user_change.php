    ...
    <section class="right-side">
        <div class="row" style="margin-left:60px ">
            ...
            if (isset($_POST['simpan'])) {
                ...
                $pass  = $_POST['pass'];
                $pass1 = $_POST['pass1'];
                $passwd_lama = $cipher->encrypt($pass_lama, $kunci); 
                $passwd = $cipher->encrypt($pass, $kunci); 
                ...
                if ($pass != $pass1) {
                    ...
                    $sql_user = " update user set pass= '".md5($passwd1)."' where username='$user' and pass='".md5($passwd_lama)."'";
