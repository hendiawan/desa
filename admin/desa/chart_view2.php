...
<div class="col-md-12" >
    ...
    <div>
        ...
        <div hidden="" class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Data Statistik Pendidikan</h3>
        ...
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">DATA STATISTIK PENDIDIKAN PENDUDUK DESA PENDEM</h3>
    ...
    <script>
                $(function() {
                    ...
                    var areaChartData = {
                        labels: ["SD", "SMP", "SMA", "S1", "S2", "S3","TIDAK SEKOLAH" ],
                        datasets: [
                            {
                                label: "A",
                            ...
                            },
                            {
                                ...
                                data: [<?php echo $sd ?>,<?php echo $smp ?>,<?php echo $sma ?>,<?php echo $s1 ?>,<?php echo $s2 ?>, <?php echo $s3 ?>, <?php echo $ts ?>]
                            }
                        ]
                    };
