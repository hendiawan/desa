...
//    echo 'Belum Ada';
    ...
    $data = mysql_fetch_object(mysql_query("select header1 from konten"));

    unlink("../../gambar/$data->header1");

    $sinopsis_upload = move_uploaded_file($tmp, "../../gambar/$file");
    $mysql_query = mysql_query("update konten set header1='$file',ket1='$ket' ");
